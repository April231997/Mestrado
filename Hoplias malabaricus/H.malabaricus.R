...
Mala2 <- read.table("H.malabaricus_Geral2.txt", header=T)
...
## Min.   : 3.20   Min.   :  1.00   Min.   :1980   Length:213         Length:213         Min.   :-53.82  
## 1st Qu.: 6.70   1st Qu.:  6.00   1st Qu.:2003   Class :character   Class :character   1st Qu.:-50.48  
## Median : 9.40   Median : 18.00   Median :2005   Mode  :character   Mode  :character   Median :-49.47  
## Mean   :10.16   Mean   : 41.09   Mean   :2003                                         Mean   :-49.65  
## 3rd Qu.:12.90   3rd Qu.: 48.70   3rd Qu.:2007                                         3rd Qu.:-49.27  
## Max.   :28.00   Max.   :454.00   Max.   :2017                                         Max.   :-42.77  
## 
## Latitude     
## Min.   :-24.69  
## 1st Qu.:-21.19  
...
shapiro.test(Mala2$CP) ## W = 0.93946, p-value = 9.636e-08
shapiro.test(Mala2$P)  ## W = 0.64586, p-value < 2.2e-16
shapiro.test(Mala2$ANO) ## W = 0.82685, p-value = 1.156e-14
...
cor(Mala2$ANO, Mala2$CP) ## 0.01500006
cor(Mala2$ANO, Mala2$P)  ## -0.01115106
cor(Mala2$ANO, Mala2$CP, method="spearman") ## 0.02597433
cor(Mala2$ANO, Mala2$P, method="spearman")  ## 0.01997922

cov(Mala2$ANO, Mala2$CP) ## 0.5296638
cov(Mala2$ANO, Mala2$P)  ## -5.267818
...
model.Mala2.cp.gamm<-gamm(CP~s(ANO), random=list(Amb=~1), data=Mala2)
...
## Parametric coefficients:
##   Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  10.1563     0.3084   32.93   <2e-16 ***
##   ---
##   Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Approximate significance of smooth terms:
##   edf Ref.df     F p-value
## s(ANO)   1      1 0.048   0.827
## 
## R-sq.(adj) =  -0.00451   
## Scale est. = 20.168    n = 213

model2.Mala2.cp.gamm<-gamm(log(CP)~s(ANO), random=list(Amb=~1), data=Mala2)
...
## Parametric coefficients:
##   Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  2.22311    0.03015   73.73   <2e-16 ***
##   ---
##   Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
##
## Approximate significance of smooth terms:
##   edf Ref.df     F p-value
## s(ANO)   1      1 0.339   0.561
##
## R-sq.(adj) =  -0.00314   
## Scale est. = 0.19271   n = 213

model3.Mala2.cp.gamm<-gamm(CP~ANO, random=list(Amb=~1), data=Mala2)
summary(model3.Mala2.cp.gamm$gam)
## Family: gaussian 
## Link function: identity 
##
## Formula:
...
## Parametric coefficients:
##   Estimate Std. Error t value Pr(>|t|)
## (Intercept) -7.09169   79.15158  -0.090    0.929
## ANO          0.00861    0.03951   0.218    0.828
##
##
## R-sq.(adj) =  -0.00451   
## Scale est. = 20.168    n = 213

model4.Mala2.cp.gamm<-gamm(log(CP)~ANO, random=list(Amb=~1), data=Mala2)
summary(model4.Mala2.cp.gamm$gam)
## Family: gaussian 
## Link function: identity 
##
## Formula:
...
## Parametric coefficients:
##   Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.269510   7.737110  -0.293    0.770
## ANO          0.002243   0.003862   0.581    0.562
##
##
## R-sq.(adj) =  -0.00314   
## Scale est. = 0.19271   n = 213

model5.Mala2.cp.lmer<-lmer(CP~ANO + (1|Amb), data = Mala2)
summary(model5.Mala2.cp.lmer)
## boundary (singular) fit: see ?isSingular
##
## Linear mixed model fit by REML. t-tests use Satterthwaite's method ['lmerModLmerTest']
## Formula: CP ~ ANO + (1 | Amb)
##    Data: Macu
##
## REML criterion at convergence: 1249.5
##
## Scaled residuals: 
##    Min      1Q  Median      3Q     Max 
## -1.5469 -0.7712 -0.1690  0.5864  3.9818 
##
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  Amb      (Intercept)  0.00    0.000   
##  Residual             20.36    4.512   
## Number of obs: 213, groups:  Amb, 2
##
## Fixed effects:
##              Estimate Std. Error        df t value Pr(>|t|)
## (Intercept)  -7.09169   79.15158 211.00000  -0.090    0.929
## ANO           0.00861    0.03951 211.00000   0.218    0.828
##
## Correlation of Fixed Effects:
##     (Intr)
## ANO -1.000
...
model6.Mala2.cp.lmer<-lmer(log(CP)~ANO + (1|Amb), data = Mala2)
summary(model6.Mala2.cp.lmer)
## boundary (singular) fit: see ?isSingular
##
## Linear mixed model fit by REML. t-tests use Satterthwaite's method ['lmerModLmerTest']
## Formula: log(CP) ~ ANO + (1 | Amb)
...
## Scaled residuals: 
##   Min       1Q   Median       3Q      Max 
## -2.41706 -0.74167  0.05001  0.71821  2.58713 
##
## Random effects:
##   Groups   Name        Variance Std.Dev.
## Amb      (Intercept) 0.0000   0.0000  
## Residual             0.1945   0.4411  
## Number of obs: 213, groups:  Amb, 2
##
## Fixed effects:
##   Estimate Std. Error         df t value Pr(>|t|)
## (Intercept)  -2.269510   7.737110 211.000000  -0.293    0.770
## ANO           0.002243   0.003862 211.000000   0.581    0.562
##
## Correlation of Fixed Effects:
##   (Intr)
## ANO -1.000
...
model.Mala2.p.gamm<-gamm(P~s(ANO), random=list(Amb=~1), data=Mala2)
...
## Parametric coefficients:
##   Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   41.087      4.127   9.957   <2e-16 ***
##   ---
##   Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
##
## Approximate significance of smooth terms:
##   edf Ref.df     F p-value
## s(ANO)   1      1 0.026   0.871
##
## R-sq.(adj) =  -0.00461   
## Scale est. = 3610.2    n = 213

model2.Mala2.p.gamm<-gamm(log(P)~s(ANO), random=list(Amb=~1), data=Mala2)
...
## Parametric coefficients:
##   Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  2.85876    0.09525   30.01   <2e-16 ***
##   ---
##   Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
##
## Approximate significance of smooth terms:
##   edf Ref.df    F p-value
## s(ANO)   1      1 0.31   0.578
##
## R-sq.(adj) =  -0.00327   
## Scale est. = 1.9233    n = 213

model3.Mala2.p.gamm<-gamm(P~ANO, random=list(Amb=~1), data=Mala2)
summary(model3.Mala2.p.gamm$gam)
## Family: gaussian 
## Link function: identity 
##
## Formula:
...
## Parametric coefficients:
##   Estimate Std. Error t value Pr(>|t|)
## (Intercept)  212.62912 1058.98221   0.201    0.841
## ANO           -0.08563    0.52862  -0.162    0.871
##
##
## R-sq.(adj) =  -0.00461   
## Scale est. = 3610.2    n = 213

model4.Mala2.p.gamm<-gamm(log(P)~ANO, random=list(Amb=~1), data=Mala2)
summary(model4.Mala2.p.gamm$gam)
## Family: gaussian 
## Link function: identity 
##
## Formula:
...
## Parametric coefficients:
##   Estimate Std. Error t value Pr(>|t|)
## (Intercept) -10.727029  24.442410  -0.439    0.661
## ANO           0.006782   0.012201   0.556    0.579
##
##
## R-sq.(adj) =  -0.00327   
## Scale est. = 1.9233    n = 213

model5.Mala2.p.lmer<-lmer(P~ANO + (1|Amb), data = Mala2)
summary(model5.Mala2.p.lmer)
## Linear mixed model fit by REML. t-tests use Satterthwaite's method ['lmerModLmerTest']
## Formula: P ~ ANO + (1 | Amb)
## Data: Macu
##
## REML criterion at convergence: 2344
##
## Scaled residuals: 
##   Min      1Q  Median      3Q     Max 
## -0.6889 -0.5745 -0.3809  0.1282  6.8449 
##
## Random effects:
##  Groups   Name        Variance Std.Dev.
## Amb      (Intercept)    2.767  1.663  
## Residual             3643.096 60.358  
## Number of obs: 213, groups:  Amb, 2
##
## Fixed effects:
##   Estimate Std. Error         df t value Pr(>|t|)
## (Intercept)  223.36589 1059.49956  204.00415   0.211    0.833
## ANO           -0.09096    0.52888  204.21859  -0.172    0.864
##
## Correlation of Fixed Effects:
##   (Intr)
## ANO -1.000

model6.Mala2.p.lmer<-lmer(log(P)~ANO + (1|Amb), data = Mala2)
summary(model6.Mala2.p.lmer)
## boundary (singular) fit: see ?isSingular
##
## Linear mixed model fit by REML. t-tests use Satterthwaite's method ['lmerModLmerTest']
## Formula: log(P) ~ ANO + (1 | Amb)
## Data: Mala2
##
## REML criterion at convergence: 753.6
##
## Scaled residuals: 
##   Min       1Q   Median       3Q      Max 
## -2.08931 -0.77420  0.00178  0.75948  2.34046 
##
## Random effects:
##   Groups   Name        Variance Std.Dev.
## Amb      (Intercept) 0.000    0.000   
## Residual             1.942    1.393   
## Number of obs: 213, groups:  Amb, 2
##
## Fixed effects:
##   Estimate Std. Error         df t value Pr(>|t|)
## (Intercept) -10.727029  24.442410 211.000000  -0.439    0.661
## ANO           0.006782   0.012201 211.000000   0.556    0.579
## 
## Correlation of Fixed Effects:
##   (Intr)
## ANO -1.000
